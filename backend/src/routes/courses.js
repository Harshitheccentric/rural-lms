 ...
 * 
 * TODO: Phase 5 - Add role-based authorization middleware
...
router.get('/:id/progress', authMiddleware, progressController.getCourseProgress);
...
// TODO: Phase 5 - Add POST /api/courses (create course - instructor only)
// TODO: Phase 5 - Add PUT /api/courses/:id (update course - instructor/owner only)
// TODO: Phase 5 - Add DELETE /api/courses/:id (delete course - instructor/owner only)
